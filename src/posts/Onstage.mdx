...
Before moving on to visual design, I had to ensure that all of these features could flow in a logical way. I grouped the critical features into 3 red routes: personalize account, buy a concert ticket, and watch a concert. “Personalize account” addressed people’s needs to be able to create a profile and set music preferences; “Buy a concert ticket”_ _included searching for concerts, getting concert info, and buying the tickets; “Watch a concert” allowed people to live-stream the concert in immersive audio and video. I would later change the wording of these routes as I went back over the designs. For now, this was enough to create user flows for the upcoming design.
...
Some of the main features I added (labeled by screen number) were:

*   7, 8: A search input to find favorite artists during onboarding instead of a massive list of artists which would overwhelm users
*   14a, 15a: Date filter modals to address the edge case of scrolling through endless concert listings
*   18, 20: A cart functionality to support people’s desire for a more realistic concert experience, like buying concert tickets in real life
*   23, 24: Helper modals explaining video player functionality to first-time users
*   28, 29: Audio and video settings for recreating a virtual concert environment, like room sound, 3D audio, and 3D video
